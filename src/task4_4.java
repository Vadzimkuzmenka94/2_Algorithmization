    ...
    public static void main(String[] args) {
        try {
            ...
            if (numberOfPoints > 0) {
                ...
                double maxDistance = calculateDistanceBetweenPoints(xCoord[arrOfIndexes[0]], yCoord[arrOfIndexes[0]],
                        xCoord[arrOfIndexes[1]], yCoord[arrOfIndexes[1]]);
                maxDistance = Math.round(maxDistance * 100) / 100.0d;

                System.out.print("\nМаксимальное расстояние = " + maxDistance + " между точками: {" +
                        xCoord[arrOfIndexes[0]] + "," + yCoord[arrOfIndexes[0]] + "}");
